...
//     setLoading(true);
//     try {
//       const res = await signIn("credentials", { redirect: false, email: values.email, password: values.password, remember: values.remember });
//       if (!res) {
...
//     const hasSeenQuickStart = session?.user?.hasSeenQuickStart;
...
//       <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 via-primary/5 to-background flex-col justify-between p-12 fixed left-0 top-0 h-screen overflow-hidden z-10">
//         <div className="flex flex-col items-center justify-center flex-1">
//           <div className="text-center space-y-8">
//             {/* <Image
//               src={mounted && theme === "dark" ? "/Light-Logo.png" : "/Dark-Logo.png"}
//               alt="Asset Manager"
//               width={200}
//               height={100}
//               className="mx-auto"
...
//                 Manage your assets efficiently with our comprehensive portfolio tracking platform.
//               </p>
//             </div>
//           </div>
//         </div>
...
//                   <Tabs defaultValue="/signin" value="/signin" onValueChange={handleTabChange} className="w-full mt-4">
//                     <TabsList className="grid w-full grid-cols-2 h-10">
//                       <TabsTrigger value="/signin" className="h-8 text-sm">Sign In</TabsTrigger>
//                       <TabsTrigger value="/signup" className="h-8 text-sm">Sign Up</TabsTrigger>
//                     </TabsList>
//                   </Tabs>
//                 </div>
...
//                             />
//                             <FormLabel htmlFor="remember" className="text-sm sm:text-base text-muted-foreground cursor-pointer">
//                               Remember me
//                             </FormLabel>
//                           </div>
//                           <FormMessage />
...
//                       </p>
//                     </div>
//                     <Button type="submit" className="w-full h-10 sm:h-12 text-base sm:text-lg" disabled={loading}>
