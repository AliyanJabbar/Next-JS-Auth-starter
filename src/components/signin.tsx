          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-foreground">
                Welcome to AJ Auth Starter
              </h1>
              <p className="text-lg text-muted-foreground max-w-md">
                Authentication issue has benn solved, just use this ready made
                template to get started, don't need to thanks AJ.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-lg space-y-2">
            ...
            <Card className="border-0 shadow-none bg-transparent">
              <CardHeader className="text-center space-y-0 pb-4">
                ...
                {!!errorState && (
                  <div className="mt-4 bg-red-100 p-3 rounded-md flex items-center gap-x-2 text-sm text-red-600">
